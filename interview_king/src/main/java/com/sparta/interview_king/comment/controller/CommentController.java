...
public class CommentController {
    ...
    public boolean createComment(@RequestBody CommentRequestDto requestDto, @AuthenticationPrincipal UserDetails userDetails) {
        //로그인 확인하기
        if (userDetails != null) {
            Long userId = userDetails.getUser().gstId();
